...
namespace Benchmark.GaussianElimination
{
    ...
    public class Program
    {
        ...
        public void FixedMatrix_Q24_8()
        {
            ...
            Matrix<Q24_8> fM = new Matrix<Q24_8>(_m);
            fM.GaussElim();
        }

        [Benchmark]
        public void FixedMatrix_Q16_16()
        {
            ...
            Matrix<Q16_16> fM = new Matrix<Q16_16>(_m);
            fM.GaussElim();
        }

        [Benchmark]
        public void FixedMatrix_Q8_24()
        {
            ...
            Matrix<Q8_24> fM = new Matrix<Q8_24>(_m);
            fM.GaussElim();
        }
